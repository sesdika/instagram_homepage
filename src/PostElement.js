...
import save_icon from "./photos/save.png"
import saved_icon from "./photos/saved.png"
        ...
        <div>
            <div className="post-element-container">
                ...
                <div className="post-element-bottom-bar">
                    ...
                    <ShareModal/>
                    <Link onClick={() => {
                            if (isSaved === false) return setIsSaved(true)
                            else if (isSaved === true) return setIsSaved(false)
                        }
                        }>
                            {isSaved ?
                                <img src={saved_icon} alt="comments" style={{position: "absolute", right: "0"}} height="26px"/>
                                :
                                <img src={save_icon} alt="comments" style={{position: "absolute", right: "0"}} height="26px"/>
                            }
                    </Link>
                </div>
